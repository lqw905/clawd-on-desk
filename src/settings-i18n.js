...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      memoryTitle: "Memory",
      memoryDesc: "Local activity snapshots collected from Clawd session events.",
      memoryStatus: "Status",
      memoryUnavailable: "Memory is unavailable",
      memoryStorage: "Storage",
      memoryDailySnapshots: "Daily snapshots",
      memoryWeeklyAggregates: "Weekly aggregates",
      memoryMonthlyAggregates: "Monthly aggregates",
      memoryPermanentRecords: "Permanent records",
      memoryUnlockedBadges: "Unlocked badges",
      memoryLastUpdated: "Last updated",
      memoryNoData: "No data yet",
      memoryOpenJournal: "Open Journal",
      memoryExportJson: "Export JSON",
      memoryExported: "Memory exported.",
      memoryDangerDeferred: "Clear data and reset growth controls are intentionally deferred until the journal is established.",
      memorySyncTitle: "GitHub Sync",
      memorySyncDesc: "Private Gist sync is opt-in and never blocks local memory writes.",
      memorySyncStatus: "Sync status",
      memorySyncEnabled: "Enable GitHub Sync",
      memorySyncEnabledState: "Enabled",
      memorySyncDisabled: "Disabled",
      memorySyncToken: "GitHub token",
      memorySyncTokenPlaceholder: "Paste a gist-scoped token",
      memorySyncTokenConfigured: "Configured",
      memorySyncGistId: "Gist ID",
      memorySyncGistPlaceholder: "Created on first push if empty",
      memorySyncAutoPull: "Pull on startup",
      memorySyncAutoPush: "Push after snapshots",
      memorySyncSave: "Save Sync",
      memorySyncPull: "Pull",
      memorySyncPush: "Push",
      memorySyncClearToken: "Clear Token",
      memorySyncSaved: "Sync settings saved.",
      memorySyncPulled: "Memory pulled and merged.",
      memorySyncPushed: "Memory pushed.",
      memorySyncLastResult: "Last result",
    ...
    zh: {
      ...
      memoryTitle: "记忆",
      memoryDesc: "基于 Clawd 会话事件生成的本地活动快照。",
      memoryStatus: "状态",
      memoryUnavailable: "记忆不可用",
      memoryStorage: "存储",
      memoryDailySnapshots: "每日快照",
      memoryWeeklyAggregates: "每周聚合",
      memoryMonthlyAggregates: "每月聚合",
      memoryPermanentRecords: "永久记录",
      memoryUnlockedBadges: "已解锁徽章",
      memoryLastUpdated: "最后更新",
      memoryNoData: "暂无数据",
      memoryOpenJournal: "打开 Journal",
      memoryExportJson: "导出 JSON",
      memoryExported: "记忆已导出。",
      memoryDangerDeferred: "清除数据和重置成长控制已刻意延后，等 Journal 稳定后再加入。",
      memorySyncTitle: "GitHub 同步",
      memorySyncDesc: "私有 Gist 同步默认关闭，不会阻塞本地记忆写入。",
      memorySyncStatus: "同步状态",
      memorySyncEnabled: "启用 GitHub 同步",
      memorySyncEnabledState: "已启用",
      memorySyncDisabled: "已关闭",
      memorySyncToken: "GitHub token",
      memorySyncTokenPlaceholder: "粘贴具备 gist 权限的 token",
      memorySyncTokenConfigured: "已配置",
      memorySyncGistId: "Gist ID",
      memorySyncGistPlaceholder: "留空时首次 Push 自动创建",
      memorySyncAutoPull: "启动时 Pull",
      memorySyncAutoPush: "快照后 Push",
      memorySyncSave: "保存同步",
      memorySyncPull: "Pull",
      memorySyncPush: "Push",
      memorySyncClearToken: "清除 Token",
      memorySyncSaved: "同步设置已保存。",
      memorySyncPulled: "记忆已拉取并合并。",
      memorySyncPushed: "记忆已推送。",
      memorySyncLastResult: "上次结果",
    ...
    "zh-TW": {
      ...
      memoryTitle: "記憶",
      memoryDesc: "基於 Clawd 工作階段事件產生的本機活動快照。",
      memoryStatus: "狀態",
      memoryUnavailable: "記憶無法使用",
      memoryStorage: "儲存",
      memoryDailySnapshots: "每日快照",
      memoryWeeklyAggregates: "每週彙總",
      memoryMonthlyAggregates: "每月彙總",
      memoryPermanentRecords: "永久記錄",
      memoryUnlockedBadges: "已解鎖徽章",
      memoryLastUpdated: "最後更新",
      memoryNoData: "尚無資料",
      memoryOpenJournal: "開啟 Journal",
      memoryExportJson: "匯出 JSON",
      memoryExported: "記憶已匯出。",
      memoryDangerDeferred: "清除資料與重置成長控制已刻意延後，待 Journal 穩定後再加入。",
      memorySyncTitle: "GitHub 同步",
      memorySyncDesc: "私有 Gist 同步預設關閉，不會阻塞本機記憶寫入。",
      memorySyncStatus: "同步狀態",
      memorySyncEnabled: "啟用 GitHub 同步",
      memorySyncEnabledState: "已啟用",
      memorySyncDisabled: "已關閉",
      memorySyncToken: "GitHub token",
      memorySyncTokenPlaceholder: "貼上具備 gist 權限的 token",
      memorySyncTokenConfigured: "已設定",
      memorySyncGistId: "Gist ID",
      memorySyncGistPlaceholder: "留空時首次 Push 自動建立",
      memorySyncAutoPull: "啟動時 Pull",
      memorySyncAutoPush: "快照後 Push",
      memorySyncSave: "儲存同步",
      memorySyncPull: "Pull",
      memorySyncPush: "Push",
      memorySyncClearToken: "清除 Token",
      memorySyncSaved: "同步設定已儲存。",
      memorySyncPulled: "記憶已拉取並合併。",
      memorySyncPushed: "記憶已推送。",
      memorySyncLastResult: "上次結果",
    ...
    ko: {
      ...
      memoryTitle: "메모리",
      memoryDesc: "Clawd 세션 이벤트에서 수집한 로컬 활동 스냅샷입니다.",
      memoryStatus: "상태",
      memoryUnavailable: "메모리를 사용할 수 없습니다",
      memoryStorage: "저장 공간",
      memoryDailySnapshots: "일별 스냅샷",
      memoryWeeklyAggregates: "주별 집계",
      memoryMonthlyAggregates: "월별 집계",
      memoryPermanentRecords: "영구 기록",
      memoryUnlockedBadges: "해제된 배지",
      memoryLastUpdated: "마지막 업데이트",
      memoryNoData: "아직 데이터 없음",
      memoryOpenJournal: "Journal 열기",
      memoryExportJson: "JSON 내보내기",
      memoryExported: "메모리를 내보냈습니다.",
      memoryDangerDeferred: "데이터 삭제와 성장 초기화 컨트롤은 Journal이 안정된 뒤 추가합니다.",
      memorySyncTitle: "GitHub 동기화",
      memorySyncDesc: "비공개 Gist 동기화는 선택 사항이며 로컬 메모리 쓰기를 막지 않습니다.",
      memorySyncStatus: "동기화 상태",
      memorySyncEnabled: "GitHub 동기화 켜기",
      memorySyncEnabledState: "켜짐",
      memorySyncDisabled: "꺼짐",
      memorySyncToken: "GitHub token",
      memorySyncTokenPlaceholder: "gist 권한 token 붙여넣기",
      memorySyncTokenConfigured: "설정됨",
      memorySyncGistId: "Gist ID",
      memorySyncGistPlaceholder: "비워두면 첫 Push 때 생성",
      memorySyncAutoPull: "시작 시 Pull",
      memorySyncAutoPush: "스냅샷 후 Push",
      memorySyncSave: "동기화 저장",
      memorySyncPull: "Pull",
      memorySyncPush: "Push",
      memorySyncClearToken: "Token 지우기",
      memorySyncSaved: "동기화 설정을 저장했습니다.",
      memorySyncPulled: "메모리를 가져와 병합했습니다.",
      memorySyncPushed: "메모리를 보냈습니다.",
      memorySyncLastResult: "마지막 결과",
    ...
    ja: {
      ...
      memoryTitle: "メモリ",
      memoryDesc: "Clawd のセッションイベントから収集したローカル活動スナップショットです。",
      memoryStatus: "状態",
      memoryUnavailable: "メモリを利用できません",
      memoryStorage: "ストレージ",
      memoryDailySnapshots: "日次スナップショット",
      memoryWeeklyAggregates: "週次集計",
      memoryMonthlyAggregates: "月次集計",
      memoryPermanentRecords: "永続記録",
      memoryUnlockedBadges: "解除済みバッジ",
      memoryLastUpdated: "最終更新",
      memoryNoData: "まだデータがありません",
      memoryOpenJournal: "Journal を開く",
      memoryExportJson: "JSON を書き出す",
      memoryExported: "メモリを書き出しました。",
      memoryDangerDeferred: "データ削除と成長リセットは Journal が安定してから追加します。",
      memorySyncTitle: "GitHub 同期",
      memorySyncDesc: "Private Gist 同期はオプトインで、ローカルメモリの書き込みを妨げません。",
      memorySyncStatus: "同期状態",
      memorySyncEnabled: "GitHub 同期を有効化",
      memorySyncEnabledState: "有効",
      memorySyncDisabled: "無効",
      memorySyncToken: "GitHub token",
      memorySyncTokenPlaceholder: "gist 権限の token を貼り付け",
      memorySyncTokenConfigured: "設定済み",
      memorySyncGistId: "Gist ID",
      memorySyncGistPlaceholder: "空なら初回 Push で作成",
      memorySyncAutoPull: "起動時に Pull",
      memorySyncAutoPush: "スナップショット後に Push",
      memorySyncSave: "同期を保存",
      memorySyncPull: "Pull",
      memorySyncPush: "Push",
      memorySyncClearToken: "Token を消去",
      memorySyncSaved: "同期設定を保存しました。",
      memorySyncPulled: "メモリを取得してマージしました。",
      memorySyncPushed: "メモリを送信しました。",
      memorySyncLastResult: "前回結果",
