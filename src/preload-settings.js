...
contextBridge.exposeInMainWorld("settingsAPI", {
  ...
  openJournal: () => ipcRenderer.invoke("settings:open-journal"),
  getMemoryStatus: () => ipcRenderer.invoke("settings:get-memory-status"),
  exportMemoryJson: () => ipcRenderer.invoke("settings:export-memory-json"),
  getMemorySyncStatus: () => ipcRenderer.invoke("settings:get-memory-sync-status"),
  configureMemorySync: (payload) => ipcRenderer.invoke("settings:configure-memory-sync", payload),
  pullMemorySync: () => ipcRenderer.invoke("settings:pull-memory-sync"),
  pushMemorySync: () => ipcRenderer.invoke("settings:push-memory-sync"),
